...
list_of_single_options = ['plot', 'plot_eco', 'plot_fil', 'phase', 'phase_plane', 'order_parameter', 'eckert', 'ciliate', 'ciliate_eco', 'ciliate_speed', 'ciliate_speed_eco', 'ciliate_traj', 
