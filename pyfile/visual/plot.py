...
list_of_single_options = ['plot', 'plot_eco', 'plot_fil', 'phase', 'wavenumber', 'phase_plane', 'order_parameter', 'roadmap', 'eckert', 'ciliate', 'ciliate_eco', 'ciliate_eco_bicilia', 'ciliate_speed', 'ciliate_speed_eco', 'ciliate_traj', 
                   'timing', 'ciliate_plane', 'ciliate_forcing', 'ciliate_dissipation', 'footpath', 'phase_diff',
                   ...
                   'phase_serial', 'full_plot', 'twofil', 'multifil', 'multifil_side', 'find_pole']
