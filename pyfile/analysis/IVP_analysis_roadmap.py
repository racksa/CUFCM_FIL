...
time_array_diaplectic = np.load(f"{path2}time_array_index12.npy")
r_array_diaplectic = np.load(f"{path2}r_array_index12.npy")
...
stamp_index_diaplectic = np.array([0, 30, 100, 599, 1506])
