// pairwisefcm_mobility_solver.cu

#include <iomanip>
#include <iostream>
#include <cmath>
#include <algorithm>
#include "pairwisefcm_mobility_solver.hpp"
#include "../cuda_functions.hpp"

pairwisefcm_mobility_solver::~pairwisefcm_mobility_solver(){}

pairwisefcm_mobility_solver::pairwisefcm_mobility_solver(){}

void pairwisefcm_mobility_solver::free_host_memory(){
...
void pairwisefcm_mobility_solver::free_device_memory(){
...
void pairwisefcm_mobility_solver::allocate_host_memory(){
...
void pairwisefcm_mobility_solver::allocate_device_memory(){
...
void pairwisefcm_mobility_solver::copy_segment_positions_to_device(){
...
void pairwisefcm_mobility_solver::copy_segment_forces_to_device(){
...
void pairwisefcm_mobility_solver::copy_blob_positions_to_device(){
...
void pairwisefcm_mobility_solver::copy_blob_forces_to_device(){
...
void pairwisefcm_mobility_solver::copy_interparticle_blob_forces_to_host(){
...
void pairwisefcm_mobility_solver::copy_blob_velocities_to_host(){
...
void pairwisefcm_mobility_solver::copy_segment_velocities_to_host(){
...
void pairwisefcm_mobility_solver::apply_interparticle_forces(){
    ...
    if (num_gpus > 1){
      ...
      pairwisefcm_mobility_solver::wait_for_device();
      pairwisefcm_mobility_solver::copy_segment_forces_to_device();
...
void pairwisefcm_mobility_solver::wait_for_device(){
...
void pairwisefcm_mobility_solver::evaluate_segment_segment_mobility(){
  ...
  int start_seg = 0;
    ...
    for (int n = 0; n < num_gpus; n++){
      ...
      Mss_mult_fcm<<<num_thread_blocks, THREADS_PER_BLOCK>>>(v_segs_device[n], f_segs_device[n], x_segs_device[n], start_seg, num_segs[n]);
...
void pairwisefcm_mobility_solver::evaluate_segment_blob_mobility(){
  ...
  for (int n = 0; n < num_gpus; n++){
    ...
    Msb_mult_fcm<<<num_thread_blocks, THREADS_PER_BLOCK>>>(v_segs_device[n], f_blobs_device[n], x_segs_device[n], x_blobs_device[n], start_seg, num_segs[n]);
...
void pairwisefcm_mobility_solver::evaluate_blob_blob_mobility(){
  ...
  for (int n = 0; n < num_gpus; n++){
    ...
    Mbb_mult_fcm<<<num_thread_blocks, THREADS_PER_BLOCK>>>(v_blobs_device[n], f_blobs_device[n], x_blobs_device[n], start_blob, num_blobs[n]);
...
void pairwisefcm_mobility_solver::evaluate_blob_segment_mobility(){
  ...
  for (int n = 0; n < num_gpus; n++){
    ...
    Mbs_mult_fcm<<<num_thread_blocks, THREADS_PER_BLOCK>>>(v_blobs_device[n], f_segs_device[n], x_blobs_device[n], x_segs_device[n], start_blob, num_blobs[n]);
...
void pairwisefcm_mobility_solver::evaluate_full_mobility(){
