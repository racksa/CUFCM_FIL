    ...
    qtemp.sqrt_in_place_ortho(dir);
      ...
      omega0 = 2.0*PI; // T = 1
        ...
        phase = 0.0; 
          ...
          // Try to read from file
          std::ifstream input_file(SIMULATION_DIR + "input/psi.dat");
          if (input_file.is_open()) {
            if(fil_id == 0){
              std::cout << "Reading all states from file: " << SIMULATION_DIR + "input/psi.dat" << std::endl;
            }
            float bin;
            input_file >> bin;
            input_file >> bin;
            ...
            std::cout << "No true_states file found: " << SIMULATION_DIR + "input/psi.dat" << std::endl;
          }
